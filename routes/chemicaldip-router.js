...
router.get("/:id/pdf", async (req, res) => {
  try {
    ...
    doc.font("thai").fontSize(13).text("เลขที่ 436 หมู่ 5 ตำบลวังตะกอ อำเภอหลังสวน จังหวัดชุมพร 86110", companyX, topY + 18);
    doc.font("thai").fontSize(13).text("โทร 081-105-5681, 098-159-3888", companyX, topY + 36);
